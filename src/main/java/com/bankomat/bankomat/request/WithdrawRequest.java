...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Запрос на снятие денег")
public class WithdrawRequest {
    ...
    @Schema(description = "Сумма для снятия", example = "100.00", required = true)
    @Positive(message = "Сумма должна быть положительной")
    private BigDecimal amount;

    @Schema(description = "Валюта", example = "BYN", allowableValues = {"BYN", "USD", "EUR"}, required = true)
